...
<!----- PDFView ------->
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="CCTVModal" tabindex="-1" role="dialog">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" value="" autocomplete="off" class="form-control" id="CustomerID" name="CustomerID" required>
        ...
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/mobile_home.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CCTV.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerCheckblanace.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerSendSlip.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerGetDataCarModal.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSwitch.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSecurity.js?v=3"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartWM.js?v=3"></script>
