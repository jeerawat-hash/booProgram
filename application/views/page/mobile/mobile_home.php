...
<!----- PDFView ------->
    ...
    <section class="content">
        ...
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/mobile_home.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CCTV.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerCheckblanace.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerSendSlip.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerGetDataCarModal.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSwitch.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSecurity.js?v=1001"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartWM.js?v=1001"></script>
