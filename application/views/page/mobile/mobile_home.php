...
<!----- PDFView ------->
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="CCTVModal" tabindex="-1" role="dialog">
        ...
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/mobile_home.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CCTV.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerCheckblanace.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerSendSlip.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerGetDataCarModal.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSwitch.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSecurity.js?v=2"></script>
        <script src="https://boo3.sakorncable.com/assets/pages/mobile/js/Mobile_SmartWM.js?v=2"></script>
